...
public class AddController implements Initializable {
    ...
    private void ActionAddService(){
        try {
            ...
            if (index != -1){
                ...
                DialogPane temp = loader.load();
                Controllers.ConfigurationControllers.ServiceControllers.AddController controller = loader.getController();
    ...
    void ActionInsert(ActionEvent event) {
        ...
        if ( !firstName.isEmpty() && !lastName.isEmpty() &&  depIndex != -1 &&  servIndex != -1){
    ...
    private boolean insert(Employee employee) {
        ...
        try {
            insert = operation.insert(employee);
            return insert;
        }catch (Exception e){
            e.printStackTrace();
            return insert;
