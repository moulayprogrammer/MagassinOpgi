...
public class AddController implements Initializable {
    ...
    private void ActionAddProvider(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/InputViews/AddProviderView.fxml"));
        ...
        if (dataSelected != null) {
            ...
            if ( ex == -1 ){
                try {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/InputViews/AddPorchesView.fxml"));
                    DialogPane temp = loader.load();
    ...
    private void ActionUpdateSales(){
        ...
        if (compoSelectedIndex != -1){
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/InputViews/UpdatePorchesView.fxml"));
                DialogPane temp = loader.load();
