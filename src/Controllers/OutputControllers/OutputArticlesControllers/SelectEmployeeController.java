...
public class SelectEmployeeController implements Initializable {
    ...
    private void ActionSelect(){
        ...
        if (data != null){
            ...
            try {
                Employee employee = operation.get(Integer.parseInt(data.get(0).getValue()));
                ...
                this.employee.setIdService(employee.getIdService());
            ...
            alertWarning.setContentText("Veuillez sélectionner un employee");
