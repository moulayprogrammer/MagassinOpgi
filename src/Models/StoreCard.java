...
public class StoreCard {
    ...
    public StoreCard(int id, int idArticle, LocalDate dateStore, int qteStored, int qteConsumed, double price) {
        this.id = id;
    ...
    public StoreCard(int id, int idArticle, int qteStored, int qteConsumed, double price) {
        this.id = id;
        this.idArticle = idArticle;
        this.qteStored = qteStored;
        this.qteConsumed = qteConsumed;
